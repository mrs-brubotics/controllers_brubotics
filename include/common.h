// file copied from https://github.com/ctu-mrs/mrs_uav_controllers/blob/master/include/common.h
#ifndef CONTROLLERS_BRUBOTICS_COMMON_H
#define CONTROLLERS_BRUBOTICS_COMMON_H
...
struct sanitizeDesiredForceandTilt {
    Eigen::Vector3d force;
    double tilt;
};
std::optional<sanitizeDesiredForceandTilt> sanitizeDesiredForce(const Eigen::Vector3d& desired_force, const double& tilt_over_limit, const double& tilt_saturation,
...
#endif  // CONTROLLERS_BRUBOTICS_COMMON_H